 <!-- Sidebar -->
 <ul class="text-white bg-warning sidebar-dark navbar-nav sidebar accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="mx-3 sidebar-brand-text">SIP RT </div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="py-2 collapse-inner">
                <a class="collapse-item" href="hoax.html">Surat Keterangan</a>
                <a class="collapse-item" href="narkoba.html">Surat Domisili</a>
                <a class="collapse-item" href="pornografi.html">Surat Ahli Waris</a>
            </div>
        </div>
    </li>
